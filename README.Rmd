...
gcVar <- 
  function(N = 50, Clusters = c("none", "non-overlapping", "overlapping") , Num.Clusters = 10, Num_Layers = NULL){
...
if(Clusters == "overlapping"){
  ...
  if(!is.null(Num_Layers)) stop("Please provide a valid Num_Layers argument when using Overlapping clusters")
