...
I now use S&P500 data since 1/01/2000 to  sample correlation matrices that can be used as inputs in the Monte Carlo procedure. These matrixes will be made available as part of the mc_market package and will be used to train CorrGAN. 
