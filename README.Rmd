...
This is the main function in the MC market package, It performs the first three steps of the Monte Carlo process. See the Roxygen documentation below for further detail.

For the purpose of this readme this version of sim_inno is slightly different to that in the final version of MCmarket. This version allow one to create hybrid multivariate copulas, this functionality is tested in section \lable{test_sim_inno}. 
