#' @title mc_market
#' @description This function produces an ensemble of market returns for an asset market with the
#' given correlation matrix. The user can adjust the markets left tail dependency as well as the
#' markets distribution and the univariate distributions of the returns.
